...
class Loader {
  ...
  static async loadOptions(params) {
    ...
    if (!domContainer) {
      ...
      (_b = document.querySelector("body")) === null || _b === void 0 ? void 0 : _b.append(domContainer);
    }
  ...
  static async set(id, domContainer, options, index) {
    ...
    const domEl = !hasId ? id : domContainer;
    const newOptions = typeof options === "number" || options === undefined ? domContainer : options;
    ...
    const newItem = new Container((_a = id) !== null && _a !== void 0 ? _a : `tsparticles${Math.floor(Math.random() * 10000)}`, currentOptions);
  ...
  static async loadJSON(tagId, jsonUrl, index) {
    ...
    if (response.ok) {
      ...
      return await Loader.load(id !== null && id !== void 0 ? id : data, id ? data : index, index);
    } else {
  ...
  static async setJSON(id, domContainer, jsonUrl, index) {
    ...
    if (typeof jsonUrl === "number" || jsonUrl === undefined) {
      url = domContainer instanceof Array ? itemFromArray(domContainer, jsonUrl) : domContainer;
    } else {
      newId = id;
      url = jsonUrl instanceof Array ? itemFromArray(jsonUrl, index) : jsonUrl;
    }
    ...
    if (response.ok) {
      ...
      return Loader.set(newId !== null && newId !== void 0 ? newId : domContainer, (_a = domContainer) !== null && _a !== void 0 ? _a : options, options !== null && options !== void 0 ? options : index, index);
    } else {
      fetchError(response.status);
    }
  }
